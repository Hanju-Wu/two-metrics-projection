...
%%
[W3,H3,iter_alspnm,time_alspnm,x_alspnm,y_alspnm] = alspnm(V,Winit,Hinit,1e-4,100,1000);
%% Plot
subplot(2,2,1)
...
semilogy(x_alspnm,y_alspnm,'Marker','diamond','MarkerIndices',[1:3:length(x_alspnm),length(x_alspnm)]);
hold off
lgd = legend('PNCG','alspgrad','alspnm');
xlabel('Time(s)')
